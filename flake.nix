{
  ...
  outputs = { self, nixpkgs, nixpkgs-unstable, flake-utils, naersk, fenix, ... }: flake-utils.lib.eachDefaultSystem (system:
  let
  ...
  in {
    ...
    devShells = {
      default = pkgs.mkShell rec {
        ...
        LD_LIBRARY_PATH = "${pkgs.lib.makeLibraryPath self.packages.${system}.nixos-autodeploy.buildInputs}";
